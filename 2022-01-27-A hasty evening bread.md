...
### Bulk ferment
Approximatly 4.5 hours (ca 18:00 to 23:00). After ca 1 hour i did 3 stretch and folds with ca 30 minutes in between each set.
...
### Proofing
Approximatly 12.5 hours. Proofed in fridge from ca 23:00 to 11:30. Two of the hours were in room temp in the morning because it thought it hadnt expanded enough, but i returned it to the fridge after that.

### Scoring the bread
Just going for an ear.
